...
import { closeResetPasswordModal } from "@/lib/store/features/auth/auth-slice";

export function ResetPasswordModal() {
  const dispatch = useAppDispatch();
  const { isResetPasswordModalOpen, resetEmail } = useAppSelector(
    (state) => state.auth
  );
  ...
  }, [isResetPasswordModalOpen, dispatch]);
